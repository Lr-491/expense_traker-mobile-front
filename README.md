J'ai développé une application mobile de gestion de dépenses avec React Native et Django REST API.
L'application permet aux utilisateurs de s'inscrire, se connecter via JWT et gérer leurs dépenses (CRUD complet).
